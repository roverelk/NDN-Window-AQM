 ...
 *     NS_LOG=ndn.Consumer:ndn.Producer ./waf --run=ndn-kjevik-XTraffic--Benchmarks
 * 
...
main(int argc, char* argv[])
{
  ...
  std::string m_outputName = "ndn-kjevik-XTraffic-Stable-2-Benchmark-600sec";
  ...
  */
  ...
  // Simulation 06: PCON with Window cross-traffic
  /*
  ndn::AppHelper consumerHelper("ns3::ndn::ConsumerPcon");
  consumerHelper.SetAttribute("Size", DoubleValue(-1));
  consumerHelper.SetAttribute("MaxSeq", UintegerValue(100000));
