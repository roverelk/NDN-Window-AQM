...
/**
 * This scenario simulates a very simple network topology in:
 * topology/topo-master-3-node.txt
 * 
 * A basic scenario which is equal to the one used in ndn-master-consumerPcon.cpp
 * This is done to be sure everything acts the same when the topology is a remote file
 * compared to being written directly into the program.
 *
...
main(int argc, char* argv[])
{
  ...
  std::string m_outputName = "ndn-kjevik-consumerWindow-RF-v3";
