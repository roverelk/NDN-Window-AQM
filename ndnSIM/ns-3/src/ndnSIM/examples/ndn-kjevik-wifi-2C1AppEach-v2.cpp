...
main(int argc, char* argv[])
{
  ...
  std::string export_file_names = "kjevik-wifi-2CRRP-BIC";
  std::string export_file_version = "v6";
  ...
  std::string topoFile = "src/ndnSIM/examples/topologies/topo-kjevik-2C-R-R-P-wifi.txt";
  ...
  //NodeContainer wifiOne;
  //wifiOne.Add(Names::Find<Node>("R1"));
  //wifiOne.Add(Names::Find<Node>("R3"));

  //NodeContainer wifiTwo;
  //wifiTwo.Add(Names::Find<Node>("R2"));
  //wifiTwo.Add(Names::Find<Node>("R3"));
  ...
  for(int i = 0; i < 3; i++)
  {
    ndn::StrategyChoiceHelper::Install(routers[i], "/", "/localhost/nfd/strategy/best-route");
  } 
  ...
  consumerHelper.SetAttribute("Window", UintegerValue(2));

  consumerHelper.SetAttribute("CcAlgorithm", StringValue("BIC")); // AIMD, BIC or CUBIC
