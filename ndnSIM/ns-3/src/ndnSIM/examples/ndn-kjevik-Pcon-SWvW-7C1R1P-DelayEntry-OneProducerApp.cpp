...
main(int argc, char* argv[])
{
  ...
  std::string topoFile = "src/ndnSIM/examples/topologies/topo-kjevik-7C-R-P.txt";
  ...
  std::string m_outputName = "ndn-kjevik-Pcon-SWvW-7C1R1P-DelayEntry-OneProducerApp-v1-2-CUBIC";
  ...
  Ptr<Node> consumers[7] = {Names::Find<Node>("C1"), Names::Find<Node>("C2"), Names::Find<Node>("C3"), 
    Names::Find<Node>("C4"), Names::Find<Node>("C5"), Names::Find<Node>("C6"), Names::Find<Node>("C7")};
  ...
  // Set up the entry of link C7<-->R1 at 8 seconds
  consumerHelper.SetPrefix(prefix[6]);
  consumerHelper.SetAttribute("StartTime", StringValue("8")); // Time s
