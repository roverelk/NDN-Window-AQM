// ndn-kjevik-Pcon-SWvW-1R5Apps.cpp
 ...
 *     NS_LOG=ndn.Consumer:ndn.Producer ./waf --run=ndn-kjevik-Pcon-SWvW-1R15Apps
 * 
 * PCON - Stop-and-Wait versus Window - 1 router with 5 applications.
...
main(int argc, char* argv[])
{
  ...
  std::string topoFile = "src/ndnSIM/examples/topologies/topo-kjevik-3-node.txt";
  ...
  std::string m_outputName = "ndn-kjevik-pcon-SWvW-1R5Apps-v3-1";
  double m_granularity = 0.25; // time in seconds

  //std::string prefix = "/prefix";
  std::string prefix[5] = {"/A", "/B", "/C", "/D", "/E"};
