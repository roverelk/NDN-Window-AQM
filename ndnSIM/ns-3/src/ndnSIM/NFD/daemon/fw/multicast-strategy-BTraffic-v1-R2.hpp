 ...
 */
class MulticastStrategyBTraffic1_R2 : public Strategy
                        , public ProcessNackTraits<MulticastStrategyBTraffic1_R2>
{
public:
  explicit
  MulticastStrategyBTraffic1_R2(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyBTraffic1_R2>;
