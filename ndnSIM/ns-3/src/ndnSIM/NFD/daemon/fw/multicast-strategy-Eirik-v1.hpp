 ...
 */
class MulticastStrategyEirik : public Strategy
                        , public ProcessNackTraits<MulticastStrategyEirik>
{
public:
  explicit
  MulticastStrategyEirik(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyEirik>;
