 ...
 */
class MulticastStrategyEirik3_R1 : public Strategy
                        , public ProcessNackTraits<MulticastStrategyEirik3_R1>
{
public:
  explicit
  MulticastStrategyEirik3_R1(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyEirik3_R1>;
