 ...
 */
class MulticastStrategySTraffic1_R1 : public Strategy
                        , public ProcessNackTraits<MulticastStrategySTraffic1_R1>
{
public:
  explicit
  MulticastStrategySTraffic1_R1(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategySTraffic1_R1>;
