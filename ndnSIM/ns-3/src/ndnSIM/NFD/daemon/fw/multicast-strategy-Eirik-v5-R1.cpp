...
#include "multicast-strategy-Eirik-v5-R1.hpp"
...
NFD_REGISTER_STRATEGY(MulticastStrategyEirik5_R1);

NFD_LOG_INIT("MulticastStrategyEirik5_R1");

const time::milliseconds MulticastStrategyEirik5_R1::RETX_SUPPRESSION_INITIAL(10);
const time::milliseconds MulticastStrategyEirik5_R1::RETX_SUPPRESSION_MAX(250);



void
MulticastStrategyEirik5_R1::updateTime ()
{
...
void
MulticastStrategyEirik5_R1::updateBandwidth ()
{
...
MulticastStrategyEirik5_R1::MulticastStrategyEirik5_R1(Forwarder& forwarder, const Name& name)
  : Strategy(forwarder)
...
const Name&
MulticastStrategyEirik5_R1::getStrategyName()
{
  static Name strategyName("/localhost/nfd/strategy/multicast-Eirik-v5-R1/%FD%05");
  return strategyName;
}

void
MulticastStrategyEirik5_R1::afterReceiveInterest(const Face& inFace, const Interest& interest,
...
void
MulticastStrategyEirik5_R1::afterReceiveNack(const Face& inFace, const lp::Nack& nack,
                                    const shared_ptr<pit::Entry>& pitEntry)
{
...
void
MulticastStrategyEirik5_R1::afterReceiveData(const shared_ptr<pit::Entry>& pitEntry,
