...
#include "multicast-strategy-Eirik-v3-R2.hpp"
...
NFD_REGISTER_STRATEGY(MulticastStrategyEirik3_R2);

NFD_LOG_INIT("MulticastStrategyEirik3_R2");

const time::milliseconds MulticastStrategyEirik3_R2::RETX_SUPPRESSION_INITIAL(10);
const time::milliseconds MulticastStrategyEirik3_R2::RETX_SUPPRESSION_MAX(250);



void
MulticastStrategyEirik3_R2::updateTime ()
{
...
void
MulticastStrategyEirik3_R2::updateBandwidth ()
{
  ...
  if(upStreamInDataQuantity > 1){
    ...
    numberOfInterestToSend = numberOfInterestToFillDownStream*1; // The last number is weighting
...
MulticastStrategyEirik3_R2::MulticastStrategyEirik3_R2(Forwarder& forwarder, const Name& name)
  : Strategy(forwarder)
...
const Name&
MulticastStrategyEirik3_R2::getStrategyName()
{
  static Name strategyName("/localhost/nfd/strategy/multicast-Eirik-v3-R2/%FD%02");
  return strategyName;
}

void
MulticastStrategyEirik3_R2::afterReceiveInterest(const Face& inFace, const Interest& interest,
...
void
MulticastStrategyEirik3_R2::afterReceiveNack(const Face& inFace, const lp::Nack& nack,
                                    const shared_ptr<pit::Entry>& pitEntry)
{
...
void
MulticastStrategyEirik3_R2::afterReceiveData(const shared_ptr<pit::Entry>& pitEntry,
