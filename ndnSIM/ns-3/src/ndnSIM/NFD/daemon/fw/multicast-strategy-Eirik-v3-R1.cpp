...
#include "multicast-strategy-Eirik-v3-R1.hpp"
...
NFD_REGISTER_STRATEGY(MulticastStrategyEirik3_R1);

NFD_LOG_INIT("MulticastStrategyEirik3_R1");

const time::milliseconds MulticastStrategyEirik3_R1::RETX_SUPPRESSION_INITIAL(10);
const time::milliseconds MulticastStrategyEirik3_R1::RETX_SUPPRESSION_MAX(250);



void
MulticastStrategyEirik3_R1::updateTime ()
{
...
void
MulticastStrategyEirik3_R1::updateBandwidth ()
{
  ...
  if(upStreamInDataQuantity > 1){
    ...
    numberOfInterestToSend = numberOfInterestToFillDownStream*1; // The last number is weightin
...
MulticastStrategyEirik3_R1::MulticastStrategyEirik3_R1(Forwarder& forwarder, const Name& name)
  : Strategy(forwarder)
...
const Name&
MulticastStrategyEirik3_R1::getStrategyName()
{
  static Name strategyName("/localhost/nfd/strategy/multicast-Eirik-v3-R1/%FD%03");
  return strategyName;
}

void
MulticastStrategyEirik3_R1::afterReceiveInterest(const Face& inFace, const Interest& interest,
...
void
MulticastStrategyEirik3_R1::afterReceiveNack(const Face& inFace, const lp::Nack& nack,
                                    const shared_ptr<pit::Entry>& pitEntry)
{
...
void
MulticastStrategyEirik3_R1::afterReceiveData(const shared_ptr<pit::Entry>& pitEntry,
