 ...
 */
class MulticastStrategyBTraffic1_R1 : public Strategy
                        , public ProcessNackTraits<MulticastStrategyBTraffic1_R1>
{
public:
  explicit
  MulticastStrategyBTraffic1_R1(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyBTraffic1_R1>;
  ...
  float downStreamInData_B_Size = 1.0;
    float downStreamInInterest_C_Quantity = 1.0;
  float downStreamInInterest_C_Size = 1.0;
  float downStreamInData_C_Quantity = 1.0;
  float downStreamInData_C_Size = 1.0;
  ...
  float upStreamInInterest_C_Quantity = 1.0;
  float upStreamInInterest_C_Size = 1.0;
  float upStreamInData_C_Quantity = 1.0;
  float upStreamInData_C_Size = 1.0;
