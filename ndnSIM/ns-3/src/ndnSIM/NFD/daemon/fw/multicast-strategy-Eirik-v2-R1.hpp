 ...
 */
class MulticastStrategyEirik2_R1 : public Strategy
                        , public ProcessNackTraits<MulticastStrategyEirik2_R1>
{
public:
  explicit
  MulticastStrategyEirik2_R1(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyEirik2_R1>;
