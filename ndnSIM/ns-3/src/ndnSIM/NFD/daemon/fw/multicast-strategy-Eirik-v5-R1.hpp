 ...
 */
class MulticastStrategyEirik5_R1 : public Strategy
                        , public ProcessNackTraits<MulticastStrategyEirik5_R1>
{
public:
  explicit
  MulticastStrategyEirik5_R1(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyEirik5_R1>;
