...
#include "multicast-strategy-STraffic-v1-R2.hpp"
...
NFD_REGISTER_STRATEGY(MulticastStrategySTraffic1_R2);

NFD_LOG_INIT("MulticastStrategySTraffic1_R2");

const time::milliseconds MulticastStrategySTraffic1_R2::RETX_SUPPRESSION_INITIAL(10);
const time::milliseconds MulticastStrategySTraffic1_R2::RETX_SUPPRESSION_MAX(250);



void
MulticastStrategySTraffic1_R2::updateTime ()
{
...
void
MulticastStrategySTraffic1_R2::updateShaper ()
{
...
MulticastStrategySTraffic1_R2::MulticastStrategySTraffic1_R2(Forwarder& forwarder, const Name& name)
  : Strategy(forwarder)
...
const Name&
MulticastStrategySTraffic1_R2::getStrategyName()
{
  static Name strategyName("/localhost/nfd/strategy/multicast-STraffic-v1-R2/%FD%01");
  return strategyName;
}

void
MulticastStrategySTraffic1_R2::afterReceiveInterest(const Face& inFace, const Interest& interest,
...
void
MulticastStrategySTraffic1_R2::afterReceiveNack(const Face& inFace, const lp::Nack& nack,
                                    const shared_ptr<pit::Entry>& pitEntry)
{
...
void
MulticastStrategySTraffic1_R2::afterReceiveData(const shared_ptr<pit::Entry>& pitEntry,
