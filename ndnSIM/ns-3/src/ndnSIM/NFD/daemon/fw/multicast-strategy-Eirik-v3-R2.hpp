 ...
 */
class MulticastStrategyEirik3_R2 : public Strategy
                        , public ProcessNackTraits<MulticastStrategyEirik3_R2>
{
public:
  explicit
  MulticastStrategyEirik3_R2(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyEirik3_R2>;
