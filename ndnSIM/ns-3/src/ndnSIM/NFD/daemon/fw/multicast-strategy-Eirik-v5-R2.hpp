 ...
 */
class MulticastStrategyEirik5_R2 : public Strategy
                        , public ProcessNackTraits<MulticastStrategyEirik5_R2>
{
public:
  explicit
  MulticastStrategyEirik5_R2(Forwarder& forwarder, const Name& name = getStrategyName());
...
private:
  friend ProcessNackTraits<MulticastStrategyEirik5_R2>;
