...
#include "multicast-strategy-Eirik-v4-R1.hpp"
...
NFD_REGISTER_STRATEGY(MulticastStrategyEirik4_R1);

NFD_LOG_INIT("MulticastStrategyEirik4_R1");

const time::milliseconds MulticastStrategyEirik4_R1::RETX_SUPPRESSION_INITIAL(10);
const time::milliseconds MulticastStrategyEirik4_R1::RETX_SUPPRESSION_MAX(250);



void
MulticastStrategyEirik4_R1::updateTime ()
{
...
void
MulticastStrategyEirik4_R1::updateBandwidth ()
{
  ...
  if(upStreamInDataQuantity > 5){
    ...
    numberOfDataToSend = (BANDWIDTH - (numberOfInterestToSend*20)) / avgDataSize;
    std::cout << "AvgDataSize:\t" << avgDataSize << "\n";
...
MulticastStrategyEirik4_R1::MulticastStrategyEirik4_R1(Forwarder& forwarder, const Name& name)
  : Strategy(forwarder)
...
const Name&
MulticastStrategyEirik4_R1::getStrategyName()
{
  static Name strategyName("/localhost/nfd/strategy/multicast-Eirik-v4-R1/%FD%04");
  return strategyName;
}

void
MulticastStrategyEirik4_R1::afterReceiveInterest(const Face& inFace, const Interest& interest,
...
void
MulticastStrategyEirik4_R1::afterReceiveNack(const Face& inFace, const lp::Nack& nack,
                                    const shared_ptr<pit::Entry>& pitEntry)
{
...
void
MulticastStrategyEirik4_R1::afterReceiveData(const shared_ptr<pit::Entry>& pitEntry,
